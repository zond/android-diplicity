...
public interface PhaseStateService {
  ...
  Observable<SingleContainer<PhaseState>> PhaseStateUpdate(@Body PhaseState phasestate, @Path("game_id") String game_id, @Path("phase_ordinal") String phase_ordinal, @Path("nation") String nation);
